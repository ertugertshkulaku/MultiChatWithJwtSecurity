...
import com.example.Authentication.services.UserDetailsServiceImpl;
  ...
  @Bean
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/root-path-chat/**").permitAll().
                antMatchers("/api/images/**").permitAll()
                .antMatchers("/api/test/**").permitAll().anyRequest().authenticated(); //lejoj aksesimin
